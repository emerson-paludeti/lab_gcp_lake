...
# --- CORREÇÃO DE CAMINHOS PARA O AIRFLOW (DOCKER) ---
# O Docker monta a pasta 'dags' dentro de '/opt/airflow/dags'.
# Precisamos apontar para o arquivo exato lá dentro.
CAMINHO_CREDENCIAL = "/opt/airflow/dags/credentials.json"

# Configura a variável de ambiente para que o Google Cloud encontre a chave automaticamente
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = CAMINHO_CREDENCIAL

# --- CONFIGURAÇÕES ---
PROJECT_ID = 'lab-dados-gcp'            # ID do projeto
...
# NOTA: Não precisamos mais passar 'credentials=' manualmente.
# As bibliotecas abaixo leem automaticamente o os.environ que configuramos acima.
